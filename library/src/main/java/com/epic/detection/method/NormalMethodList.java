...
import com.epic.detection.handler.ContentResolverHandler;
import com.epic.detection.handler.SettingsResolverHandler;
...
public class NormalMethodList extends HookMethodList {
    ...
    public LinkedList<ClassMethodGroup> getAbsMethodList() {
        ...
        pkgManagerHook.addMethod("getInstalledApplications");
    ...
    protected LinkedList<MethodWrapper> addList(LinkedList<MethodWrapper> list) {
        //-------设备信息
        list.add(new MethodWrapper(android.app.ActivityManager.class,"getRunningAppProcesses")); //获取进程信息
        list.add(new MethodWrapper(android.net.wifi.WifiInfo.class,"getSSID"));
        list.add(new MethodWrapper(WifiManager.class,"getScanResults"));
        list.add(new MethodWrapper(android.telephony.TelephonyManager.class,"getCellLocation"));
        ...
        list.add(new MethodWrapper(android.telephony.TelephonyManager.class,"getSubscriberId",int.class)); //imsi
